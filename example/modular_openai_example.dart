...
/// Comprehensive example demonstrating the modular OpenAI provider
///
/// This example showcases the new modular architecture inspired by async-openai,
...
void main() async {
  ...
  print('=== Modular OpenAI Provider Example ===\n');

  // Create modular OpenAI provider
  ...
  final provider = ModularOpenAIProvider(config);
...
Future<void> demonstrateChatCapability(ModularOpenAIProvider provider) async {
...
Future<void> demonstrateEmbeddingCapability(
    ModularOpenAIProvider provider) async {
...
Future<void> demonstrateAudioCapabilities(
    ModularOpenAIProvider provider) async {
...
Future<void> demonstrateImageGeneration(ModularOpenAIProvider provider) async {
...
Future<void> demonstrateFileManagement(ModularOpenAIProvider provider) async {
...
Future<void> demonstrateModeration(ModularOpenAIProvider provider) async {
...
Future<void> demonstrateModelListing(ModularOpenAIProvider provider) async {
...
Future<void> demonstrateAssistants(ModularOpenAIProvider provider) async {
...
Future<void> demonstrateCompletion(ModularOpenAIProvider provider) async {
